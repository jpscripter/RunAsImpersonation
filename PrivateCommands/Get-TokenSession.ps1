...
param(
    ...
    $InfoPointer = Get-TokenInfoPtr -Token $PtrToken -TokenInformationClass TokenSessionId
    [System.Runtime.InteropServices.Marshal]::PtrToStructure($InfoPointer,[type][uint32])   
